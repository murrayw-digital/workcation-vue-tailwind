<template>
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    <header class="bg-gray-900">
      ...
      <nav>
        <div class="px-2 pt-1 pb-5 border-b border-gray-800">
          <a
            href="#"
            class="block px-3 py-1 rounded font-semibold text-white hover:bg-gray-600"
          >List your property</a>
          <a
            href="#"
            class="mt-2 block px-3 py-1 rounded font-semibold text-white hover:bg-gray-600"
          >Trips</a>
          <a
            href="#"
            class="mt-2 leading-tight block px-3 py-1 rounded font-semibold text-white hover:bg-gray-600"
          >Messages</a>
        </div>
        <div class="px-4 pt-3 pb-5">
          <div class="flex items-center">
            <img
              ...
              src="https://images.unsplash.com/photo-1567468219153-4b1dea5227ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80"
              alt
            />
        ...
        <div class="relative px-3 -mt-16">
          <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
            ...
            <div class="mt-1">
              ...
              <span class="ml-1 text-gray-500 text-sm">/wk</span>
            </div>
            <div class="mt-2 flex items-center text-sm text-gray-600">
              <svg
                class="h-4 w-4 fill-current text-teal-500"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
